...
class AddConcertTest extends TestCase
{
    ...
    public function adding_a_valid_concert()
    {
        ...
        // 'tap' takes a $value and a $callback/anonymous function.
        // The callback will execute with the $value as the argument.
    ...
    /** @test */
    public function ticket_quantity_required()
    {
        $user = factory(User::class)->create();
    ...
    /** @test */
    public function ticket_quantity_must_be_a_whole_number()
    {
        $user = factory(User::class)->create();
